...
// Định nghĩa dữ liệu cấu hình cho 3 thẻ lựa chọn
const SELECTION_CARDS = [
  {
    ...
    path: "https://fe-blog-livid.vercel.app/",
    icon: (
  ...
  },
  {
    ...
    path: "https://fe-sample-khoa-hoc.vercel.app/",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  return (
    <section className="w-full min-h-screen bg-white flex flex-col justify-center items-center py-16 px-6 md:px-12 font-sans select-none">
      <div className="max-w-[1400px] w-full mx-auto">
        ...
        {/* Lưới hiển thị 3 sự lựa chọn khổng lồ (Responsive 1 cột trên mobile, 3 cột trên laptop) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {SELECTION_CARDS.map((card) => (
            <Link
              key={card.id}
              to={card.path}
              className="group relative rounded-[28px] overflow-hidden bg-zinc-900 min-h-[420px] md:min-h-[480px] flex flex-col justify-end p-8 border border-gray-100 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer"
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                />
                {/* Lớp phủ màu chuyển sắc giúp text ở đáy luôn hiển thị rõ nét trên mọi nền ảnh */}
              ...
              <div className="relative z-20 text-white">
                ...
                {/* Nút hành động giả định hướng mắt nhìn */}
